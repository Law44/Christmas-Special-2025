        ...
        <div className="bg-slate-800 p-6 rounded-2xl shadow-xl space-y-6 border border-slate-700">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-slate-700 border border-slate-600 rounded-lg focus:ring-2 focus:ring-emerald-500 text-white outline-none transition"
          ...
          <div className="space-y-4">
            <div className="pt-4 border-t border-slate-700">
              <h3 className="text-lg font-semibold text-white mb-3">Unirse a Partida</h3>
              <div className="flex gap-2">
                <input
                  type="text"
                  onChange={(e: any) => joinGame(e.target.value)}
                  className="flex-1 px-4 py-3 bg-slate-700 border border-slate-600 rounded-lg text-white uppercase placeholder-slate-500 outline-none"
                  placeholder="CÓDIGO"
                  maxLength={4}
                />
              </div>
            ...
            <div className="pt-4 border-t border-slate-700">
              <h3 className="text-lg font-semibold text-white mb-3">Crear Partida (Host)</h3>
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full mt-1 px-3 py-2 bg-slate-700 rounded text-white border border-slate-600"
                  />
                </div>
                <div>
              ...
              <button
                onClick={createGame}
                disabled={loading}
                className="w-full py-3 bg-emerald-600 hover:bg-emerald-500 rounded-lg font-bold text-white transition flex items-center justify-center gap-2 disabled:opacity-50"
              >
